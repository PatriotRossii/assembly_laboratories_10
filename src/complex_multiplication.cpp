...
extern "C" void complex_multiplication_(volatile __m256 *vec1, volatile __m256 *vec2, __m256 *add, __m256 *sub, __m256 *mul, __m256 *div);
...
int main() {
  {
    ...
    complex_multiplication_(&odds, &evens, &add, &sub, &mul, &div);
  ...
  }
  {
    ...
    __m256 add, sub, mul, div;
    complex_multiplication_(&vec2, &vec1, &add, &sub, &mul, &div);
